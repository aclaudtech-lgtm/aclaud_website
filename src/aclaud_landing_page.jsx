...
import { Shield, Cloud, Lock, Settings, Clock, Briefcase, KeyRound, Users } from 'lucide-react';

export default function Home() {
  return (
    <main className="text-slate-100 bg-[#0E1B2A] min-h-screen font-inter">
      {/* Hero Section */}
      <section className="flex flex-col items-center justify-center text-center py-24 px-6 bg-gradient-to-b from-[#0E1B2A] to-[#11263A]">
        <motion.h1
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          <a href="#contact" className="bg-[#1E90FF] text-white px-6 py-3 rounded-xl font-semibold hover:bg-blue-500 transition">Schedule Discovery Call</a>
          <a href="#services" className="border border-blue-400 text-blue-300 px-6 py-3 rounded-xl font-semibold hover:bg-blue-900/30 transition">Request Capabilities Deck</a>
        </div>
      </section>
          ...
          {[
            {
              ...
              desc: 'Design and assess scalable, secure cloud infrastructure for AWS, Azure, and GCP.',
            },
            {
              icon: Shield,
              title: 'Security & Compliance Advisory',
              desc: 'Build risk frameworks and audit readiness for SOC 2, ISO 27001, and GDPR.',
            },
            {
              icon: Settings,
              title: 'DevSecOps & Automation',
              desc: 'Automate security controls, identity, and deployment guardrails across environments.',
            },
            {
              icon: Lock,
              title: 'Fractional Security Leadership',
              desc: 'Part-time or project-based CISO-level guidance without full-time overhead.',
            },
          ].map((service, i) => (
            <motion.div
              key={i}
              className="bg-[#0E1B2A] p-6 rounded-2xl shadow-lg border border-slate-700 hover:border-blue-400 transition"
      ...
      <section className="py-24 px-6 text-center max-w-5xl mx-auto">
        <h2 className="text-3xl font-bold mb-12">Flexible. Confidential. Results-Oriented.</h2>
        <div className="grid md:grid-cols-3 gap-8">
          {[
            { icon: Clock, title: 'Fractional Engagements', desc: 'Part-time or retained advisory for ongoing needs.' },
            { icon: Briefcase, title: 'Project-Based Advisory', desc: 'Short-term, clearly scoped projects for audits or architecture design.' },
            { icon: KeyRound, title: 'Under NDA', desc: 'All discussions and deliverables protected by mutual confidentiality.' },
          ].map((item, i) => (
            <div key={i} className="bg-[#11263A] p-6 rounded-2xl border border-slate-700">
      ...
      {/* Process */}
      <section className="bg-[#0E1B2A] py-24 px-6 text-center">
      ...
      {/* Why Aclaud */}
      <section className="py-24 px-6 bg-[#11263A] text-center">
